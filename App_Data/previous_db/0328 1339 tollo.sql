...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2019 at 02:20 AM
...
INSERT INTO `exercises` (`id`, `name`, `description`, `categoryid`) VALUES
...
(22, '2019-03-25', '', 0, 0, '10:21:00', 'hey'),
(23, '2019-03-25', '', 1, 0, '21:09:00', 'datetest');
...
(1, 'justi', '$2y$10$MpbfeEil7E0lDKTRhtfqROil9bufELNg6oPrbA2NbkCvNGrxCw9aO', 'justincoutinho95@gmail.com', '../img/deadpool.jpg', NULL, NULL, NULL);
...
ALTER TABLE `exercises`
  ADD PRIMARY KEY (`id`),
  ADD KEY `exercises_fk_categories` (`categoryid`);
...
--
ALTER TABLE `exercises`
  ADD CONSTRAINT `exercises_fk_categories` FOREIGN KEY (`categoryid`) REFERENCES `categories` (`id`);
